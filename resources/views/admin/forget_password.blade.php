...
<html lang="en">
    ...
    <form class="mt-4 pt-2" action="{{route('admin.password_submit')}}" method="post">
        ...
        <div class="mb-3">
            <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">EMAIL PASSWORD LINK RESET</button>
        </div>
    </form>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Sonkin   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Sonkin</p>
                                    </div>
                                </div>
                            </div>
                        </div>
